...
namespace Destructible2D.Examples
{
	...
	public class D2dPlayerSpaceship : MonoBehaviour
	{
		...
		/// <summary>Rotation speed multiplier.</summary>
		...
		protected virtual void HandleKeyboardMovement()
		{
			// Get keyboard input
			float moveX = 0f;
			float moveY = 0f;
			...
			// Apply movement directly to position (no physics delays)
...
namespace Destructible2D.Examples
{
	...
	public class D2dPlayerSpaceship_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			Draw("MoveSpeed", "Movement speed multiplier.");
			Draw("RotateSpeed", "Rotation speed multiplier.");
